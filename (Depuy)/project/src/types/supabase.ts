...
// Sales Pipeline Additional Types
export interface SalesOpportunity {
  ...
  created_date: string;
  lead_source: 'website' | 'referral' | 'cold_call' | 'email_campaign' | 'trade_show' | 'partner' | 'direct_inquiry' | 'social_media' | 'other';
...
export interface OpportunityActivity {
  id: string;
  opportunity_id: string;
  activity_type: 'call' | 'email' | 'meeting' | 'demo' | 'follow_up' | 'proposal_sent' | 'contract_sent' | 'note' | 'other';
  title: string;
  description?: string;
